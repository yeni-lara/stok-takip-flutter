                            ...
                            <div class="card border-info">
                                <div class="card-body text-center">
                                    ...
                                    <div id="barcode-scanner" style="max-width: 400px; margin: 0 auto;">
                                        <div id="video" style="width: 400px; height: 400px; border: 2px dashed #0dcaf0; border-radius: 8px; background: #000; margin: 0 auto; overflow: hidden; position: relative;"></div>
                                    </div>
                                    <div class="mt-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function startBarcodeScanner() {
        ...
        Html5Qrcode.getCameras().then(devices => {
            ...
            cameraStatus.innerHTML = '<span class="text-danger">❌ Kamera listesi alınamadı</span>';
        });
    }
