    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0">
                    Tedarikçi Düzenle: {{ $supplier->name }}
                </h1>
                <div class="btn-group">
                            ...
                            <form action="{{ route('suppliers.update', $supplier) }}" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                                      id="notes" name="notes" rows="2">{{ old('notes', $supplier->notes) }}</textarea>
                                            @error('notes')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    @if($supplier->products()->count() === 0)
                                        <button type="button" class="btn btn-danger ms-auto" onclick="deleteSupplier()">
                                            <i class="bi bi-trash me-1"></i>Tedarikçiyi Sil
                                        </button>
                                    @endif
                                </div>
                            </form>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">
                                <i class="bi bi-info-circle me-2"></i>Tedarikçi Bilgileri
                            </h6>
                        </div>
                        <div class="card-body">
                            ...
                            @if($supplier->products()->count() > 0)
                                <div class="alert alert-warning mt-3">
                                    ...
                                    <small>Bu tedarikçiye ait {{ $supplier->products()->count() }} ürün bulunduğu için tedarikçi silinemez.</small>
                                </div>
                            @endif
                        </div>
                    </div>
