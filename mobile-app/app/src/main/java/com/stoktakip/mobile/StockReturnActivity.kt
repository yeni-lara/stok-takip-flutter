                ...
                private fun fetchProductByBarcode(barcode: String) {
                    ...
                    client.newCall(request).enqueue(object : Callback {
                        override fun onFailure(call: Call, e: IOException) {
                            runOnUiThread {
                                Toast.makeText(this@StockReturnActivity, "Ürün bilgisi alınamadı: ${e.message}", Toast.LENGTH_LONG).show()
                            }
                        }
                            ...
                            runOnUiThread {
                                if (response.isSuccessful && responseBody != null) {
                                    try {
                                        ...
                                        Toast.makeText(this@StockReturnActivity, "Ürün bilgisi işlenirken hata: ${e.message}", Toast.LENGTH_LONG).show()
                                        clearProductInfo()
                                    }
                                } else {
                                    Toast.makeText(this@StockReturnActivity, "Ürün bulunamadı", Toast.LENGTH_LONG).show()
                                    clearProductInfo()
                                }
                            }
                        }
